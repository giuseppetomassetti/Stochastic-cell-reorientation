...
# INSTRUCTIONS: This script generates Figure 13a showing the evolution of order parameter S(t) for ε_max = 5%
# Run the entire script to solve the ODE system and produce evolution_S_our_model005.png
...
for (i, eps_max) in enumerate([0.05] * sqrt(3/2))
...
begin
    ...
    display(p)
    savefig("evolution_S_our_model005.png")
end
