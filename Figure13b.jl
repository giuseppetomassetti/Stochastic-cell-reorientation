...
# INSTRUCTIONS: This script generates Figure 13b showing the evolution of order parameter S(t) for ε_max = 2%
# Run the entire script to solve the ODE system and produce evolution_S_our_model002.png
...
for (i, eps_max) in enumerate([0.02, 0.05, 0.10] * sqrt(3/2))
...
begin
    ...
    display(p)
    savefig("evolution_S_our_model002.png")
end
